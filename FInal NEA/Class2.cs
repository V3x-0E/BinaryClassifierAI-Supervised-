...
namespace FInal_NEA
{
    internal class node
    {
        ...
        public string[] rpositive = System.IO.File.ReadAllLines(@"C:\Users\Joshua\OneDrive\Documents\A level work\Comp sci A level\NEA\rpositive1.csv");
        public string[] rnegative = System.IO.File.ReadAllLines(@"C:\Users\Joshua\OneDrive\Documents\A level work\Comp sci A level\NEA\rnegativ1.csv");
        // file containing follow up questions
        public string[] questionbank = System.IO.File.ReadAllLines(@"C:\Users\Joshua\OneDrive\Documents\A level work\Comp sci A level\NEA\qb1.csv"); 
        //states user propmpt 
        public void startp()
        {
